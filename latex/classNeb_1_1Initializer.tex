...
\hypertarget{classNeb_1_1Initializer_aa6c409694511459956b7cfbc27feb8fc}{\index{\-Neb\-::\-Initializer@{\-Neb\-::\-Initializer}!alloc@{alloc}}
\index{alloc@{alloc}!Neb::Initializer@{\-Neb\-::\-Initializer}}
\subsubsection[{alloc}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ template$<$class... \-Alloc\-Args, class... \-Init\-Args$>$ shared {\bf \-Neb\-::\-Initializer}$<$ \-T $>$\-::{\bf alloc} (
\begin{DoxyParamCaption}
\item[{long}]{hash\-\_\-code, }
\item[{std\-::tuple$<$ \-Alloc\-Args...$>$ \&\&}]{allocargs, }
\item[{std\-::tuple$<$ \-Init\-Args...$>$ \&\&}]{initargs}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{classNeb_1_1Initializer_aa6c409694511459956b7cfbc27feb8fc}
