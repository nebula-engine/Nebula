...
///////////////////////////////////////////////////////////////////////////////
					...
					AssetManager::AssetManager(SampleRenderer::Renderer& renderer) :
	m_renderer(renderer)
{
}
...
SampleAsset*		AssetManager::getAsset(const char* path, SampleAsset::Type type)
{	
...
void				AssetManager::returnAsset(SampleAsset& asset)
{
...
SampleAsset*		AssetManager::findAsset(const char* path)
{
...
SampleAsset*		AssetManager::loadAsset(const char* path)
{
...
void				AssetManager::releaseAsset(SampleAsset& asset)
{
	PxU32 numAssets = (PxU32)m_assets.size();
...
SampleAsset*		AssetManager::loadXMLAsset(FILE& file, const char* path)
{
	SampleAsset* asset = NULL;
...
SampleAsset*		AssetManager::loadTextureAsset(FILE& file, const char* path, SampleTextureAsset::Type texType)
{
	SampleTextureAsset* asset = new SampleTextureAsset(getRenderer(), file, path, texType);
	return asset;
}

SampleAsset*		AssetManager::loadODSAsset(FILE& file, const char* path)
{
	SampleAsset* asset = NULL;
