...
math::geo::rectangle::rectangle(vec3 center, vec3 n, vec3 x, float w, float h) {
	...
	auto v0(sp::make_shared<math::geo::vertex>(center - x - y, n));
	auto v1(sp::make_shared<math::geo::vertex>(center + x - y, n));
	auto v2(sp::make_shared<math::geo::vertex>(center + x + y, n));
	auto v3(sp::make_shared<math::geo::vertex>(center - x + y, n));
