...
math::vec3 neb::control::rigid_body::control::t(double time) {
...
math::vec3 neb::control::rigid_body::control::t0() {
	NEBULA_DEBUG_1_FUNCTION;

	return raw_.torque_;
}
math::vec3 neb::control::rigid_body::control::t1(double time) {
	NEBULA_DEBUG_1_FUNCTION;
