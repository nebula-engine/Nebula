...
void	nebula::content::universe::admin::base::init(boost::shared_ptr<nebula::content::base> parent)
{
	parent_ = parent;
}
void	nebula::content::universe::admin::base::VShutDown()
{
	scenes_.foreach(boost::bind(&nebula::content::scene::admin::base::shutdown,_1));
}
void	nebula::content::universe::admin::base::VUpdate()
{
