...
void	n36000::base::init( jess::shared_ptr<nebula::content::base> parent )
{
	jess::clog << NEB_FUNCSIG << std::endl;
...
void	n36000::base::add_actor( jess::shared_ptr<n34100::base> act )
{
...
jess::shared_ptr<n34200::rigid_dynamic>		n36000::base::create_rigid_dynamic()
{
	...
	jess::shared_ptr<n34200::rigid_dynamic> act( new n34200::rigid_dynamic() );
...
jess::shared_ptr<n34200::controller>		n36000::base::create_controller( jess::shared_ptr<n32100::base> scene )
{
