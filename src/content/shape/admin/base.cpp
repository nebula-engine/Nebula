...
nebula::content::shape::admin::base::base( std::shared_ptr<n34100::rigid_actor> parent ):
	parent_( parent ),
...
void	nebula::content::shape::admin::base::render( std::shared_ptr<n23000::base> rnd )
{
	jess::clog << NEB_FUNCSIG << std::endl;
