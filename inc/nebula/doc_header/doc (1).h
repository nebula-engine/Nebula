 ...
 * 
 * 
 * Upper_Case:                  namespace, class, struct, union, enum, free function
 * ALL_CAPS:                    define, typedef
 * lower_case:                  local variable
 * lower_case_with_underscore_: member variable
 * Uppercase_With_Underscore_:  member function
 * 
 * \section audio Audio
 Possible SDKs
 - OpenAL
 ...
 terminal system/interface
 spawn point system



 Future Additions
 Change pointer arguments to const references where applicable
 Menu
 hover detection for menu objects
 background scene in menus
 Game
 Vehicles
 aircraft
 Objective
 custom programmable objectives
 AI
 custom programmable AI
 Socket
...
*         - terrain (FLOATistic shape and texture)
	...
	*/
	 ...
	 *         - Assembly
	 *         - C
	 * - Learn/Use existing file formats for...
	 *     - 3D models/skeletal animation
	 *         - from XNA
	 *             - .X and .FBX
	 *     - MD2, MD3, MD5, BSP
	 *     - levels
	 * - xml file standard to store
	 *     - levels
	 *     - actors
	 *     - ...
	 * - oo menu system
