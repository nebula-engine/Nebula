		...
		physx::PxSceneQueryFilterFlags& filterFlags)
{
	...
	PX_ASSERT(filterData0.word3 & phx::filter::filter::UNDRIVABLE_SURFACE);

	physx::PxU32 w3 = filterData1.word3 & phx::filter::filter::DRIVABLE_SURFACE;
	
	printf("%x %x %x %x\n", filterData0.word3, filterData1.word3, phx::filter::filter::DRIVABLE_SURFACE, w3);
...
std::shared_ptr<neb::core::actor::vehicle>	neb::vehicle_manager::create_vehicle(
		physx::PxPhysics* physics,
		physx::PxScene* scene,
		sp::shared_ptr<neb::core::actor::desc> desc) {
