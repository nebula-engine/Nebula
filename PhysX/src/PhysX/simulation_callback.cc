...
void	phx::simulation_callback::onContact(
	 ...
	 */
	auto actor0 = reinterpret_cast<phx::core::actor::actor::base*>(pxactor0->userData);//->isPxActorBase();
	auto actor1 = reinterpret_cast<phx::core::actor::actor::base*>(pxactor1->userData);//->isPxActorBase();
